...
@inject(({ dnaStore }) => {
    return {
        data: dnaStore.data,
        dnaList: dnaStore.dnaList,
        dnaAdd: dnaStore.dnaAdd,
        dnaEdit: dnaStore.dnaEdit,
        updateImage: dnaStore.updateImage,
    }
})
@observer
class Dna extends Component {
    ...
    render() {
        ...
        return (
            <Card bordered={false} className="dna">
                ...
                <AddDna {...modalProps} modalVisible={addModalVisible} />
                <EditDna {...modalProps} modalVisible={editModalVisible} selectedRows={selectedRows} />
