...
import AddRaiders from './addRaiders';  
import EditRaiders from './editRaiders';
...
@inject(({ raidersStore }) => {
    return {
        data: raidersStore.data,
        raidersList: raidersStore.raidersList,
        raidersAdd: raidersStore.raidersAdd,
        raidersEdit: raidersStore.raidersEdit,
        updateImage: raidersStore.updateImage,
    }
})
@observer
class Raiders extends Component {
    ...
    handleAllCommit = (action, fields) => {
        if (action === 'add') {
            this.props.raidersAdd(fields, res => {
        ...
        if (action === 'edit') {
            this.props.raidersEdit(fields, res => {
                message.success(res.message)
                this.renderTable()
            })
        }
    ...
    render() {
        ...
        return (
            <Card bordered={false} className="raiders">
                ...
                <AddRaiders {...modalProps} modalVisible={addModalVisible} />
                <EditRaiders {...modalProps} modalVisible={editModalVisible} selectedRows={selectedRows} />
