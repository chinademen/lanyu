...
@Form.create()
class AddRaiders extends Component {
    constructor(props) {
        super(props);
        this.state = {
            title: '',
    ...
    okHandle = () => {
        ...
        this.props.handleAllCommit(Action.add, fieldsValue);  // 提交数据
    }
        ...
        return (
            ...
            >
                <Row>
                    <Col span={2}>标题：</Col>
                    <Col span={20}>
                        <Input name="title" placeholder="标题" value={this.state.title} onChange={(e) => this.handleChange('title', e)} />
                    </Col>
                </Row>
                <Row>
                    <Col span={2}>作者：</Col>
                    <Col span={20}>
                        <Input name="author" placeholder="作者" value={this.state.author} onChange={(e) => this.handleChange('author', e)} />
                    </Col>
                </Row>
                <Row>
                    <Col span={2}>访问量：</Col>
                    <Col span={20}>
                        <Input name="views" placeholder="访问量" value={this.state.views} onChange={(e) => this.handleChange('views', e)} />
                    </Col>
                </Row>
                <Row>
                    <Col span={2}>点赞数量：</Col>
                    <Col span={20}>
                        <Input name="points" placeholder="点赞数量" value={this.state.points} onChange={(e) => this.handleChange('points', e)} />
                    </Col>
                </Row>
                <Row>
                    <Col span={2}>内容：</Col>
