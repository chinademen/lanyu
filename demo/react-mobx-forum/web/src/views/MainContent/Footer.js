            ...
            <div className="footer">
                ...
                <div className="footer-info">
                    <div className="footer_about">
                        <a href="#" target="_blank" style={{ width: 76 }}>关于xxx咨询</a>
                        <a href="#" target="_blank" style={{ width: 86 }}>关于xxx社区</a>
                        <a href="#" target="_blank" style={{ width: 64 }}>加入我们</a>
                        <a href="#" target="_blank" style={{ width: 118 }}>广告刊登/合作提案</a>
                        <a href="#" target="_blank" style={{ borderRight: 'none' }}>投诉举报</a>
                    </div>
                ...
                <div className="footer-banquan">
                    ...
                    <p>
                        咨询版权归xxx所有 ( <a href="#" target="_blank">www.baidu.com</a> )
                    </p>
                </div>
            </div>
        )
