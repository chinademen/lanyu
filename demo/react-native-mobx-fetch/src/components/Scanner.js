        ...
        <View style={styles.header}>
            ...
            >
                <Image style={{width: 30, height: 30, marginBottom: 5}}
                       source={require('@/assets/dh/images/resource/ic_back_white.png')}/>
...
const ScannerPromptTitle = () => {
    return (
        <View style={{marginTop: 30, flexDirection: 'row', justifyContent: 'center', alignItems: 'center'}}>
            <Image style={{width: 22, height: 22}} source={require('@/assets/dh/images/resource/ic_scan_gray.png')}/>
        ...
        return (
            <View style={{marginTop: 30, alignSelf: 'center'}}>
                <ImageBackground
                    ...
                    source={require('@/assets/dh/images/resource/img_scan_area.png')}
                >
                    <Animated.Image
                        style={[styles.scanLine, {top: positionY}]}
                        source={require('@/assets/dh/images/resource/img_scan_line.png')}
                        resizeMode="contain"
                    />
                </ImageBackground>
            </View>
