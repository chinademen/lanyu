...
const FoodCardComponent = ({
    ...
    return (
        <View style={{flex: 1, backgroundColor: 'white'}}>
            <Header
                title='查看详情'
                rightIcon={require('@/assets/dh/images/resource/ic_photo_share.png')}
                onBack={popAction}
                onRight={shareAction}
            />
                ...
                >
                    <View style={{
                        ...
                        <Image
                            ...
                            defaultSource={require('@/assets/dh/images/resource/img_default_avatar.png')}
                        />
                    ...
                    <Image
                        ...
                        defaultSource={require('@/assets/dh/images/resource/img_horizontal_default.png')}
                        resizeMode={'contain'}
                    />
                    {feed.description !== '' &&
                    <View style={{
            ...
            >
                <Image style={{width: 18, height: 18}} source={require('@/assets/dh/images/resource/ic_feed_like.png')}/>
            ...
            <View style={styles.bottomWrapper}>
                ...
                >
                    <Image
                        ...
                        source={require('@/assets/dh/images/resource/ic_share_black.png')}
                        resizeMode="contain"
                    />
                ...
                >
                    <Image
                        ...
                        source={require('@/assets/dh/images/resource/ic_article_collect.png')}
                        resizeMode="contain"
                    />
